...
upgradeAdapter.bootstrap(document.body, ['aftestApp'], {strictDi: true});
...
// adapter.addProvider(AUTH_PROVIDERS);
...
// adapter.upgradeNg1Provider('$sce');
// adapter.upgradeNg1Provider('Auth');
